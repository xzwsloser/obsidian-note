...
1. [多米诺和托米诺平铺](https://leetcode.cn/problems/domino-and-tromino-tiling/)  挺好的一道动态规划题,但是状态转移方程比较难想,甚至涉及到一定的数学推导,思路还是比较容易想到的,就是考虑最后添加的矩形即可
![[Pasted image 20250508105215.png]]
